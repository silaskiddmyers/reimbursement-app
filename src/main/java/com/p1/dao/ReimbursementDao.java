...
public interface ReimbursementDao {
    /**
     * The reason this takes in so many different parameters and has many different
     * cases is because it consolidates three different functions.
     * To avoid copying and pasting, especially since the SQL query being executed
     * is very long, this should be easier to test
     * 
     * @param getByType  is either 0, 1 or 2: 1 means it searches by status, 2 means
     *                   by name. 0 returns all reciepts
