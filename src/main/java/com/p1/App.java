...
public final class App {
    ...
    public static void main(String[] args) {
        ...
        app.get("/api/reimbursement/retrieveType={retrieveType}&retrieveParam={retrieveParam}", reimbursementController::retrieveReimbursementsBy);   
        app.post("/api/reimbursement", reimbursementController::createNewReimbursementReport);
        app.patch("/api/reimbursement/reimbId={reimbId}&newStatus={newStatus}", reimbursementController::resolveReimbursement);
